...
For the basic App, since all data remains on your device, security of that data depends on your device's security measures. We recommend keeping your browser and operating system updated to ensure the best protection of any locally stored data.
...
We may update this privacy policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. When we make changes, we will update the "Last Updated" date at the top of the policy.
...
- **App Store Compliance**: Our app complies with the requirements set by Apple App Store and Google Play Store. Your use of these platforms is also subject to their respective terms of service and privacy policies.
...
- For MetaDeck service inquiries: Contact us at privacy@metadeck.net

Thank you for using the Unofficial Dominion Assistant and MetaDeck services!

---

*Note: This privacy policy is provided for informational purposes only and should not be considered legal advice. While we've made every effort to create an accurate representation of our data practices, you may want to consult with a legal professional to ensure your specific implementation meets all applicable legal requirements. This is especially important when implementing online services that collect and process personal data like the MetaDeck service.*
