...
export enum FutureAction {
  ...
  ADD_POTIONS = 'Add {COUNT} Potions',
  REMOVE_POTIONS = 'Remove {COUNT} Potions',
  ...
  ADD_NEXT_TURN_POTIONS = 'Add {COUNT} Next Turn Potions',
  REMOVE_NEXT_TURN_POTIONS = 'Remove {COUNT} Next Turn Potions',
...
export const futureActionMap: Record<GameLogAction, FutureAction> = {
  ...
  [GameLogAction.ADD_POTIONS]: FutureAction.ADD_POTIONS,
  [GameLogAction.REMOVE_POTIONS]: FutureAction.REMOVE_POTIONS,
  ...
  [GameLogAction.ADD_NEXT_TURN_POTIONS]: FutureAction.ADD_NEXT_TURN_POTIONS,
  [GameLogAction.REMOVE_NEXT_TURN_POTIONS]: FutureAction.REMOVE_NEXT_TURN_POTIONS,
