 ...
 *
 * This function creates a complete deep copy of the input. For primitive values and non-object types, it returns the value unchanged. If the value is a Date, a new Date instance is created with the same time. Arrays are recursively cloned, and plain objects have each of their own enumerable properties deep cloned.
 *
